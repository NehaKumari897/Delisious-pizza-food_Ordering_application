            ...
            <div
                ...
                <div className="carousel-inner" id='carousel'>
                    ...
                    <div className="carousel-item active">
                        <img src="./image/pizza.jpg" className="d-block w-100" style={{ filter: "brightness(30%)" }} alt="..." />
                    </div>
                    ...
                    <div className="carousel-item">
                        <img src="./image/momos.jpg" className="d-block w-100" style={{ filter: "brightness(30%)" }} alt="..." />
                    </div>
                </div>
